...
# Summary
In this article I covered a lot of information. The article started with information on how to register your application with Facebook, touched on app modes and the use of Test Users, and we covered access tokens and permissions. The article then covered the Facebook SDK for Android and how to integrate the Android SDK into your app and build process. We then covered a sample app that showed how to use the Login API, the Graph API, and the Sharing API.
